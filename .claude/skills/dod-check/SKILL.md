...
/dod-check change/feature    # 勾 feature 变更 DoD
/dod-check change/bugfix     # 勾 bugfix 变更 DoD
/dod-check change/refactor   # 勾 refactor 变更 DoD
/dod-check change/hotfix     # 勾 hotfix 变更 DoD
/dod-check change/doc        # 勾 doc 变更 DoD
/dod-check change/decision   # 勾 ADR DoD
```
...
| `change/feature` | `docs/process/dod/change/feature.md` |
| `change/bugfix` | `docs/process/dod/change/bugfix.md` |
| `change/refactor` | `docs/process/dod/change/refactor.md` |
| `change/hotfix` | `docs/process/dod/change/hotfix.md` |
| `change/doc` | `docs/process/dod/change/doc.md` |
| `change/decision` | `docs/process/dod/change/decision.md` |
...
读 DoD 模板,提取每条勾选项(如 `- [ ] D0-01: ...`)。
编号方案统一为 `D0-NN` / `D1-NN` / ... / `CF-NN` / `CB-NN` / ...(详 spec §4)。
...
=== Phase 0 charter DoD 勾选 ===
  ...
  ✓ D0-01: docs/00_charter.md §1.1 项目名/一句话/适用场景 三项都填了
  ✓ D0-02: §1.2 适用场景 ≥ 3 条
  ✓ D0-03: §2.1 核心目标 ≥ 3 条
  ✗ D0-04: §2.2 非目标 ≥ 3 条(当前 2 条)
  ✓ D0-05: §2.5 技术栈确认签字完整
  ✗ D0-06: §3.1 角色清单 ≥ 2 行(当前 1 行)
  ...
